...
module.exports = {
  ...
  getCertificateInfo: function (cert, cb) {
    ...
    openssl.on('close', function (code) {
      ...
      // Check if output is exact four lines or does not contain "X509v3 Subject Alternative Name"
      ...
      infoObject.X509v3 = X509v3_Elements.replace('DNS:', '').split(',').map(item => item.trim());
